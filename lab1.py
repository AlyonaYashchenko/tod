...
try:
    ...
    if connection.is_connected():
        ...
        students_data = [
            ("Алла Гофіна", 20, "john.doe@example.com"),
            ("Олег Каразін", 22, "jane.smith@example.com"),
            ("Віктор Шевчук", 19, "david.johnson@example.com"),
            ("Олександра Підривна", 21, "emily.brown@example.com"),
            ("Віктор Красний", 23, "michael.wilson@example.com")
        ]
